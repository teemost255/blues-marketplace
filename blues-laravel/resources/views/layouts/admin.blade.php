...
<aside id="admin-sidebar"
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        ...
        <a href="{{ route('admin.herosms-log') }}" class="sidebar-link {{ request()->routeIs('admin.herosms-log*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.system-tools') }}" class="sidebar-link {{ request()->routeIs('admin.system-tools*') ? 'active' : '' }}">
