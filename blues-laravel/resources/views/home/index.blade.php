        ...
        <div class="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div class="flex-1 text-center lg:text-left reveal-left">
                ...
                <div class="space-y-4 mb-10">
                    @foreach([
                        ['icon'=>'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z','color'=>'text-brand','bg'=>'bg-brand/10','title'=>'Instant wallet top-up','desc'=>'Fund your wallet in seconds via Kora'],
