...
class VirtualNumberSettingsController extends Controller
{
    public function index()
    {
        $settings = [
            ...
            'herosms_markup_pct'         => Setting::get('herosms_markup_pct', '0'),
        ];
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'herosms_markup_pct'        => 'nullable|numeric|min:0|max:500',
        ]);
        ...
        $keys = [
            ...
            'herosms_expiry_minutes', 'herosms_max_active', 'herosms_markup_pct',
        ];
        foreach ($keys as $key) {
