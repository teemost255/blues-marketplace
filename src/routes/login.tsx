  ...
  return (
    <div className="grid min-h-screen md:grid-cols-2">
      <div className="hidden flex-col justify-between p-12 text-white md:flex" style={{ background: "var(--gradient-hero)" }}>
        ...
        <div>
          <h2 className="text-3xl font-bold leading-tight">Welcome back to the marketplace.</h2>
          <p className="mt-3 text-white/80">Sign in to browse, purchase, and manage your digital products.</p>
        </div>
        <div className="text-sm text-white/60">Secure auth · Paystack checkout</div>
      </div>
