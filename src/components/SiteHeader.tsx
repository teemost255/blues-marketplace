              ...
              <nav className="mt-6 space-y-1">
                ...
                {user && (
                  <>
                    ...
                    {role === "admin" && <Link to="/admin" onClick={() => setOpen(false)} className="block rounded-md px-3 py-2 text-sm hover:bg-secondary">Admin</Link>}
                  </>
                )}
              </nav>
            </SheetContent>
          ...
          {user ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                {role === "admin" && <DropdownMenuItem asChild><Link to="/admin"><ShieldCheck className="mr-2 h-4 w-4" />Admin</Link></DropdownMenuItem>}
                <DropdownMenuSeparator />
